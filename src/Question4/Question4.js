	...
	return (
		<>
			...
			<ul>
				...
				<li>The <code>results</code> parameter indicates the number of items you want to return;</li>
				<li>The <code>page</code> parameter indicates the page you want to return;</li>
				<li>The <code>seed</code> parameter is to always return the same results (don't need to touch this parameter);</li>
